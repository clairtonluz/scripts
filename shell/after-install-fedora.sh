...
# RPM Fusion no Fedora 28
sudo dnf install http://download1.rpmfusion.org/free/fedora/rpmfusion-free-release-28.noarch.rpm http://download1.rpmfusion.org/nonfree/fedora/rpmfusion-nonfree-release-28.noarch.rpm
...
sudo dnf -y install vlc vim git geany htop gimp wine postgresql-server
